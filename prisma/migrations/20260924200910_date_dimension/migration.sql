...
CREATE TABLE "calendar_settings" (
    ...
    "blockedWeekdays" TEXT NOT NULL DEFAULT '[1]',
...
INSERT INTO "new_product_variants" ("archived", "description", "id", "name", "servings", "sortOrder") SELECT "archived", "description", "id", "name", "servings", "sortOrder" FROM "product_variants";
